    ...
    <div class="navbar-wrapper">
        ...
        <div class="navbar-container content">
            <div class="collapse navbar-collapse" id="navbar-mobile">
                ...
                <span class="mr-1"> مرحباً سيد
                  <span
                      class="user-name text-bold-700">  أسامة </span>
                </span>
                            <span class="avatar avatar-online">
                  <img style="height: 35px;" src="{{asset('assets/images/products/akCbKZDCcbgbpm4iga6sEp8SKaVWLIctI4283QnG.jpg')}}" alt="avatar"><i></i></span>
                        </a>
